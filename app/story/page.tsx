...
export const metadata: Metadata = {
  title: "Our Story — Cozy Coffee Café",
  description: "Friendly, welcoming, warmth, togetherness — one table, two chairs, whole neighborhood",
};
    ...
    <div className="mx-auto max-w-6xl px-4 sm:px-6 py-10">
      <div className="max-w-2xl">
        ...
        <p className="mt-4 text-[17px] leading-7 text-espresso/70">
          We didn&apos;t open a coffee shop. We opened a living room. The bell still rings the same way it did on day one — you walk
          in, the warmth hits, and someone nods like you belong. Because you do.
        </p>
      </div>
      ...
      <div className="mt-6 grid gap-6 md:grid-cols-[1.1fr_0.9fr]">
        ...
        <div className="rounded-[24px] border bg-cream p-6 flex flex-col justify-center">
          <p className="font-hand text-2xl text-clay">“We remember how you take it.”</p>
          <p className="mt-3 text-sm leading-6 text-espresso/60">
            Sourcing: washed Colombia, natural Ethiopia this season. Milk steamed slow at 62°C. Bread baked at 5am, 48h ferment.
            Butter cultured nearby. Pastries small, honest, crumbs expected.
          </p>
          <p className="mt-3 text-xs tracking-[0.16em] uppercase text-espresso/40">Visit — 123 Warmth Lane · 7am daily</p>
        </div>
      </div>
      ...
      <div className="mt-14 rounded-[24px] border bg-fog/30 p-8">
        ...
        <p className="mt-2 text-sm leading-6 text-espresso/60 max-w-2xl">
          ...
          together — we taste at 7am, all of us, before we open. Come taste tomorrow.
        </p>
      </div>
    </div>
  );
