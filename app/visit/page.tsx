...
export const metadata: Metadata = {
  title: "Visit â€” Cozy Coffee CafÃ©",
  description: "Hours, map, amenities â€” 123 Warmth Lane, open daily. Your usual table is waiting.",
};
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 sm:px-6 py-10">
      <div className="max-w-2xl">
        ...
        <p className="mt-3 text-[17px] leading-7 text-espresso/70">123 Warmth Lane Â· hello@cozy.coffee Â· (555) 123-4567</p>
      </div>
        ...
        <div className="rounded-[24px] border bg-white p-6 shadow-warm">
          ...
          <div className="mt-4 space-y-2 text-sm text-espresso/70">
            <div className="flex justify-between">
              <span>Monâ€“Fri</span>
              <span className="font-medium text-espresso">7am â€“ 7pm</span>
            </div>
            <div className="flex justify-between">
              <span>Satâ€“Sun</span>
              <span className="font-medium text-espresso">8am â€“ 6pm</span>
            </div>
          </div>
          <div className="mt-6">
            ...
            <ul className="mt-3 grid grid-cols-2 gap-2 text-sm text-espresso/60">
              <li>â€¢ Dogs welcome</li>
              <li>â€¢ Kids + high chairs</li>
              <li>â€¢ WiFi â€” ask kindly</li>
              <li>â€¢ No outlets, slow table</li>
              <li>â€¢ Wheelchair access</li>
              <li>â€¢ Street parking</li>
            </ul>
          </div>
          ...
          <div className="aspect-[4/3] relative bg-muted">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="rounded-full bg-espresso text-cream px-5 py-3 text-sm shadow-warm">
                123 Warmth Lane Â· Your table here
              </div>
            </div>
            <div className="absolute bottom-3 left-3 right-3 rounded-[16px] border bg-white p-3 text-xs text-espresso/60">
              Google Maps embed â†’ replace with &lt;iframe&gt; when you have API key. For MVP, link above works â€” no JS bloat.
            </div>
          </div>
          <div className="p-5">
            ...
            <p className="mt-2 text-sm leading-6 text-espresso/60">
              Bring a book, bring a friend. The slow table has no outlet â€” on purpose. First sip together at 7am, daily. First
      ...
      <div className="mt-8 rounded-[16px] border border-dashed bg-cream p-6">
        ...
        <div className="mt-4 grid gap-4 md:grid-cols-2 text-sm text-espresso/60">
          <div>
            ...
            <p className="mt-1">For 5+ or the slow table, yes. Others â€” just come.</p>
          </div>
          <div>
            <p className="font-medium text-espresso">Allergens?</p>
            <p className="mt-1">Noted on the board. Tell us â€” we remember.</p>
          </div>
        </div>
      </div>
    </div>
