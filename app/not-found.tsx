    ...
    <div className="mx-auto max-w-6xl px-4 sm:px-6 py-16 md:py-24">
      <div className="mx-auto max-w-2xl text-center">
        <p className="inline-flex items-center gap-2 rounded-full border bg-fog px-4 py-1 text-xs tracking-[0.18em] uppercase text-espresso/60">
          ...
          404 â€” the room you looked for isn&apos;t poured yet
        </p>
        ...
        <p className="mt-6 text-[17px] leading-7 text-espresso/60 max-w-xl mx-auto">
          Friendly, warm, and always together â€” but this page wandered off like foam art in the wind. Your usual table is
        ...
        <div className="mx-auto mt-10 relative aspect-[4/2.5] max-w-md overflow-hidden rounded-[24px] border bg-fog shadow-warm">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center p-6 text-center">
            ...
            <p className="font-hand text-2xl text-clay -mt-2">â€œNot on the board todayâ€</p>
            <p className="mt-3 text-xs tracking-[0.16em] uppercase text-espresso/40">Wood Â· linen Â· steam Â· together</p>
          </div>
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img
            src="https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?w=800&q=80&auto=format&fit=crop"
            alt="Empty cozy cafÃ© table"
        ...
        <p className="mt-10 font-hand text-lg text-espresso/30">psst â€” first sip tomorrow 7am is on us.</p>
      </div>
    </div>
  );
}
